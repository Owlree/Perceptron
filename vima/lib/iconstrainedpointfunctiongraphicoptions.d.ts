 ...
 */
export interface IConstrainedPointFunctionGraphicOptions extends IPointGraphicOptions {
    x?: number | Variable<number>;
}
//# sourceMappingURL=iconstrainedpointfunctiongraphicoptions.d.ts.map